...
f_delete(){
	clear
	read -p "Are you sure you want to delete all the files? (Y/N)" del
	case $del in
	Y|y) rm -rf ~/Kali; echo ""; echo "Deleted all files"; echo ""; read -p "Press [Enter] to continue"; f_deviceselect;;
	N|n) echo ""; echo "Ok, your files are safe!"; echo ""; read -p "Press [Enter] to continue"; f_menu;;
	*) f_delete;;
}
